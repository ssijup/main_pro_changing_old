...
class CreateAdvocatesListView(APIView):
    def post(self, request):        
        ...
        request.data['type_of_user'] = 'normal_advocate'
        serializer = NormalAdvocateSerializer(data=request.data)
...
class EditAdvocateProfileView(APIView):
    def patch(self, request, id): 
        try:
            ...
            serializer = NormalAdvocateSerializer(advocate, data=request.data)
            if serializer.is_valid():
                serializer.save()
